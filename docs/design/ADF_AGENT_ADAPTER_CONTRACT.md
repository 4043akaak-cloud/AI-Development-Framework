...
5. **評価**: 品質、独立性、誤検知、見逃し、時間、費用、記録負担、停止の有効性を記録する。測り方と記録欄は[Observability and Evaluation Baseline §5](ADF_OBSERVABILITY_AND_EVALUATION_BASELINE.md)のAdapter評価シートを使う（設計提案。未承認）。
